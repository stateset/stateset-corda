    ...
    override fun verify(tx: LedgerTransaction) {
        ...
        when(proposalCommand.value) {
            ...
            is Commands.ReviewProposal -> requireThat {
                ...
                "only the job status should change" using (proposalInput.copy(proposalStatus = proposalOutput.proposalStatus) == proposalOutput)
            ...
            is Commands.AcceptProposal -> requireThat {
                ...
                "the proposal in unchanged apart from the status field" using (proposalInput.copy(proposalStatus = proposalOutput.proposalStatus) == proposalOutput)
            }
            ...
            is Commands.RejectProposal -> requireThat {
                ...
                "only the status must change" using (proposalInput.copy(proposalStatus = proposalOutput.proposalStatus) == proposalOutput)
