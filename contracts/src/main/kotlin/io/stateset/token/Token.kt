...
val StatesetTokenType: TokenType = TokenType(tokenIdentifier = "STATE, fractionDigits = 2)"
...
// Stateset Token Type
val statesetTokenType = StatesetTokenType("STATE", 2)
...
val tenStates: Amount<IssuedTokenType> = 10 of STATE issuedBy issuer
